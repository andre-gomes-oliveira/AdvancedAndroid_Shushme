...
public class MainActivity extends AppCompatActivity
    ...
    protected void onResume() {
        ...
        CheckBox locPermissionBox = findViewById(R.id.location_permission_checkBox);
        if (ActivityCompat.checkSelfPermission(MainActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            locPermissionBox.setChecked(false);
        } else {
            locPermissionBox.setChecked(true);
            locPermissionBox.setEnabled(false);
        }
    }
    ...
    public void onAddPlaceButtonClicked(View view) {
        if (ActivityCompat.checkSelfPermission(MainActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(this, "Location permission disabled, please enable it", Toast.LENGTH_LONG).show();
        } else {
